...
extern void show_thread_group_state_filter(const char *tg_comm, unsigned long state_filter); // muskie
 ...
 * mempolicy */
	...
	struct task_struct  *blocked_by; // muskie
	unsigned long        blocked_since; // muskie
#endif
